...
#SBATCH -t 1-0
#
# Plain AE — spatial tokens Stage B (schema v2).
# Canonical copy: AE_TTS/stageB_spatial_v2/plain_ae/
#
# Env: CHECKPOINT  OUT_DIR  VERIFY_NIFTI_SLICE_GEOMETRY=1
...
CHECKPOINT="${CHECKPOINT:-$AE_TTS/outputs/train_plain_ae/checkpoint_best.pth}"
OUT_DIR="${OUT_DIR:-$AE_TTS/outputs/diff3dformer_stageB_plain_ae_spatial_v2}"
